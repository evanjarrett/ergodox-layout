...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     *
     * ,--------------------------------------------------.         ,--------------------------------------------------.
     * | On/Off |  Dim |Bright|  F10 |  F11 |  F12 |      |         |  -   |  *   |  /   |  Num |      |      |        |
     * |--------+------+------+------+------+-------------|         |------+------+------+------+------+------+--------|
     * | Animat | Hue- | Hue+ |  F7  |  F8  |  F9  |      |         |  +   |  7   |  8   |  9   |      |      |        |
     * |--------+------+------+------+------+------|      |         |      |------+------+------+------+------+--------|
     * |        |      |      |  F4  |  F5  |  F6  |------|         |------|  4   |  5   |  6   |      |      |        |
     * |--------+------+------+------+------+------|      |         | Enter|------+------+------+------+------+--------|
     * |        |      |      |  F1  |  F2  |  F3  |      |         |      |  1   |  2   |  3   |      |      |        |
    ...
    [LAYER_NUMBERS] = LAYOUT_ergodox(
            RGB_TOG,    RGB_VAD,  RGB_VAI,  KC_F10,   KC_F11,   KC_F12,   _______,
            RGB_MOD,    RGB_HUD,  RGB_HUI,  KC_F7,    KC_F8,    KC_F9,    _______,
            RGB_SAD,    _______,  _______,  KC_F4,    KC_F5,    KC_F6,
    ...
    [LAYER_MACROS] = LAYOUT_ergodox(
            ...
            _______,  _______, _______, _______, _______, _______, _______,
                      _______, _______, _______,  M_LSLA, _______, _______,
            _______,  _______, _______, _______, _______, _______, _______,
                               _______, _______, _______, _______, _______,
            _______,  _______,
            _______,
